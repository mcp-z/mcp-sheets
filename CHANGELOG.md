...
what is in it; the 1.x entries that used to head this file are on the `v1.2.4` tag.
...
`npm install @mcp-z/mcp-sheets@latest`. If you import types from `@mcp-z/server`, two names moved:
